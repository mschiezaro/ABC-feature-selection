...
public class AllExecution {
	...
	public static void main(String[] args) {
		...
		e.writeMsg("ZooFeatureSelectionExecution");
		features = new boolean[] { true, true, true, true, true, true, true,
				true, true, true, true, true, true, true, true, true };
		fs = new ZooFeatureSelectionExecution(features);
		fs.executeAll();
		...
		e.writeMsg("SickFeatureSelectionExecution");
		features = new boolean[] { true, true, true, true, true, true, true,
				true, true, true, true, true, true, true, true, true, true,
				true, true, true, true, true, true, true, true, true, true,
				true, true };
		fs = new SickFeatureSelectionExecution(features);
		fs.executeAll();

		e.writeMsg("SonarFeatureSelectionExecution");
		features = new boolean[] { true, true, true, true, true, true, true,
				true, true, true, true, true, true, true, true, true, true,
				true, true, true, true, true, true, true, true, true, true,
				true, true, true, true, true, true, true, true, true, true,
				...
				true, true, true, true, true, true, true, true, true, true,
				true, true, true };
		fs = new SonarFeatureSelectionExecution(features);
		fs.executeAll();
