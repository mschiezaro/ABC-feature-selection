...
public class BCancerFeatureSelectionExecution extends FeatureSelectionExecution {
	...
	private AsyncFeatureSelection featureSelection;
	
	public BCancerFeatureSelectionExecution(boolean[] features) {
		super( "breast-cancer.arff", features, 100, 6, 0.1, new IBk());
	}
	...
	public void executeWithNormalization() {
		...
		featureSelection = new AsyncFeatureSelection(runtime, limit, mr,
