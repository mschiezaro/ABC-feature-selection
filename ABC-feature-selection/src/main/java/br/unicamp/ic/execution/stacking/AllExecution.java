...
public class AllExecution {
	...
	public static void main(String[] args) throws IOException {
		...
		e.writeMsg("FaceYale64x64FeatureSelectionExecution");
		features = new boolean[] { true, true, true, true, true, true, true, true, true, true,
	               true, true, true, true, true, true, true, true, true, true,
	               true, true, true, true, true, true, true, true, true, true,
	               true, true, true, true, true, true, true, true, true, true,
	               true, true, true, true, true, true, true, true, true, true,
		...
		fs = new FaceYale64x64FeatureSelectionExecution(features);
		fs.executeAll();
		writer.close();		
	}
